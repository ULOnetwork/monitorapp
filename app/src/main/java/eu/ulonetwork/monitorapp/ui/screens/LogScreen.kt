...
/**
 * Collapsed by default to keep the list scannable, showing only the timestamp, ISSUE/RESOLVED
 * status and title; tapping the row expands it to reveal the text snippet, notified channels and
 * any delivery errors.
 */
@Composable
